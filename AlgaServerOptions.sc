AlgaServerOptions {
	...
	*new { | sampleRate=48000, blockSize=256, memSize=524288/*8192*64*/, numBuffers=(1024*24),
	...
	init { | argSampleRate=48000, argBlockSize=256, argMemSize=524288/*8192*64*/, argNumBuffers=(1024*24),
